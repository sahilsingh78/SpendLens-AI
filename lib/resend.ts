  ...
  ">
    ...
    ">
      ...
      ${
        audit.totalMonthlySavings >
        0
          ? `You could save ${formatCurrencyFull(
              audit.totalMonthlySavings
            )}/month`
    ...
    ">
      ...
      ${
        audit.totalMonthlySavings >
        0
          ? `We identified ${formatCurrencyFull(
              audit.totalAnnualSavings
            )}/year in potential savings across your AI tooling stack.`
...
">
  ...
  <p style="
    ...
    margin-bottom:18px;
  ">
    Credex helps startups access discounted
    Anthropic and OpenAI credits at
...
`;
  ...
  const subject =
    audit.totalMonthlySavings >
    0
      ? `SpendLens Audit: ${formatCurrencyFull(
          audit.totalMonthlySavings
        )}/mo savings identified`
